...
const products: Record<string, { id: string; image: string; name: string; price: string }[]> = {
  "Daily Wear": [
    ...
    { id: "dw3", image: product2, name: "White Oud Light", price: "₹2,799" },
  ],
  "Spiritual": [
    { id: "sp1", image: product5, name: "Noor Al Madinah", price: "₹4,999" },
    { id: "sp2", image: product3, name: "Musk Al Tahara", price: "₹6,299" },
    { id: "sp3", image: product1, name: "Sakinah Blend", price: "₹3,799" },
  ],
  Office: [
  ...
  "Hajj & Umrah": [
    ...
    { id: "hu2", image: product3, name: "Arafa Scent", price: "₹6,899" },
    { id: "hu3", image: product5, name: "Imaan Fragrance", price: "₹4,599" },
  ],
  "Special Giftings": [
    { id: "sg1", image: product3, name: "Oud Mehar Luxury", price: "₹12,999" },
    { id: "sg2", image: product5, name: "Bridal Rose Gold", price: "₹7,499" },
    { id: "sg3", image: product2, name: "Sultan Royal Set", price: "₹15,999" },
  ],
};
