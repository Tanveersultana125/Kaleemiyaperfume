...
const WhatsAppButton = () => {
  const phoneNumber = "919885655591"; 
  const message = "As-salamu alaykum Kaleemiya! I would like to inquire about your fragrances.";
  ...
  return (
    ...
    >
      <a 
        ...
        className="w-12 h-12 bg-[#25D366] rounded-full shadow-2xl flex items-center justify-center text-white hover:scale-110 transition-transform relative group border border-white/20"
      ...
      >
        ...
        <span className="absolute -top-0.5 -right-0.5 flex h-4 w-4">
          ...
          <span className="relative inline-flex rounded-full h-4 w-4 bg-white/20 blur-[1px]"></span>
        </span>
      </a>
    </motion.div>
  );
